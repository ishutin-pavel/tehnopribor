...
"CREATE TABLE IF NOT EXISTS `".$prefix."order` (
  ...
  `close_date` timestamp NOT NULL DEFAULT ".$curTimestamp.",
  `pay_date` timestamp NOT NULL DEFAULT ".$curTimestamp.",
  ...
  `number` varchar(32),
  `hash` VARCHAR(32),
  `1c_last_export` TIMESTAMP NOT NULL DEFAULT ".$curTimestamp.",  
  `orders_set` INT( 11 ),
...
(5, 'ROBOKASSA', 1, '{\"Логин\":\"\",\"пароль 1\":\"\",\"пароль 2\":\"\",\"Метод шифрования\":\"".CRYPT::mgCrypt('md5')."\"}', '{\"result URL:\":\"/payment?id=5&pay=result\",\"success URL:\":\"/payment?id=5&pay=success\",\"fail URL:\":\"/payment?id=5&pay=fail\"}', 5, '".md5($siteName)."', 'fiz'),
...
(10, 'PayMaster', 1, '{\"ID магазина\":\"\",\"Секретный ключ\":\"\",\"Метод шифрования\":\"".CRYPT::mgCrypt('md5')."\",\"Использовать онлайн кассу\":\"ZmFsc2VoWSo2bms3ISEjMnFq\",\"НДС, включенный в цену\":\"MTglaFkqNm5rNyEhIzJxag==\"}', '{\"result URL:\":\"/payment?id=10&pay=result\",\"success URL:\":\"/payment?id=10&pay=success\",\"fail URL:\":\"/payment?id=10&pay=fail\"}', 10, '".md5($siteName)."', 'fiz'),
(11, 'AlfaBank', '1',  '{\"Логин\":\"\",\"Пароль\":\"\",\"Адрес сервера\":\"\",\"Метод шифрования\":\"".CRYPT::mgCrypt('md5')."\"}',  '{\"result URL:\":\"/payment?id=11&pay=result\",\"success URL:\":\"/payment?id=11&pay=success\",\"fail URL:\":\"/payment?id=11&pay=fail\"}' , 11, '".md5($siteName)."', 'fiz'),
(14, 'Яндекс.Касса', 1, '{\"Ссылка для отправки данных\":\"\",\"Идентификатор магазина\":\"\",\"Идентификатор витрины\":\"\",\"shopPassword\":\"\",\"Метод шифрования\":\"".CRYPT::mgCrypt('md5')."\",\"Использовать онлайн кассу\":\"ZmFsc2VoWSo2bms3ISEjMnFq\",\"НДС, включенный в цену\":\"MTglaFkqNm5rNyEhIzJxag==\"}', '{\"result URL:\":\"/payment?id=14&pay=result\",\"success URL:\":\"/payment?id=14&pay=success\",\"fail URL:\":\"/payment?id=14&pay=fail\"}', 12, '".md5($siteName)."', 'fiz'), 
...
(17, 'Сбербанк', 1, '{\"API Логин\":\"\",\"Пароль\":\"\",\"Адрес сервера\":\"\"}', '', 15, '".md5($siteName)."', 'fiz'),
...
('licenceKey', '4bbcbdba7412524a022ba6ce41744e32', 'N', 'LICENCE_KEY'),
...
('phoneMask', '+7 (999) 999-99-99', 'Y', 'PHONE_MASK'),
...
('dateActivateKey ', '2037-10-10 00:00:00', 'N', ''),
...
('catalog_meta_title', 'Купить {titeCategory} в Москве', 'N', ''),
('catalog_meta_description', '{cat_desc,160}', 'N', ''),
('catalog_meta_keywords', '{meta_keywords}', 'N', ''),
('product_meta_title', 'Купить {title} в Москве', 'N', ''),
('product_meta_description', 'Акция! {title} за {price} {currency} купить в Москве. {description,100}', 'N', ''),
