...
class Actioner {
  ...
  public function addProduct() {
    if(USER::access('product') < 2) {
      $this->messageError = 'Недостаточно прав для создания товаров!';
      return false;
    }
  ...
  public function cloneProduct() {
    if(USER::access('product') < 2) {
      $this->messageError = 'Недостаточно прав для редактирования!';
      return false;
    }
    $model = new Models_Product;
    $model->clone = true;
  ...
  public function addNewPlugin() {
    if(USER::access('plugin') < 2) {
      $this->messageError = 'Недостаточно прав для загрузки плагина!';
      return false;
    }
  ...
  public function addNewTemplate() {
    if(USER::access('setting') < 2) {
      $this->messageError = 'Недостаточно прав для загрузки шаблона!';
      return false;
    }
    if (isset($_POST) && 'POST' == $_SERVER['REQUEST_METHOD']) {
  ...
  public function checkPluginsUpdate() {
    if(USER::access('plugin') < 2) {
      $this->messageError = 'Недостаточно прав для просмотра обновлений!';
      return false;
    }
  ...
  public function updatePlugin() {
    if(USER::access('plugin') < 2) {
      $this->messageError = 'Недостаточно прав для обновления плагина!';
      return false;
    }
  ...
  public function deletePlugin() {
    if(USER::access('plugin') < 2) {
      $this->messageError = 'Недостаточно прав для удаления плагина!';
      return false;
    }
  ...
  public function addImageUrl() {
    ...
    if ($headers['Content-Type'] == 'image/jpeg' || $headers['Content-Type'] == 'image/png' || $headers['Content-Type'] == 'image/gif') {
      ...
      $this->messageError = 'Файл по ссылке недоступен или не является изображением.';
      return false;
    }
  }
  ...
  public function addImageUploader() {
    ...
    if ($_POST['imgType'] == 'image/jpeg' || $_POST['imgType'] == 'image/png' || $_POST['imgType'] == 'image/gif') {
      ...
      $this->messageError = 'Файл не является изображением.';
      return false;
    }
  }
  ...
  public function deleteCategory() {
    if(USER::access('category') < 2) {
      $this->messageError = 'Недостаточно прав для удаления категории!';
      return false;
    }
  ...
  public function deletePage() {
    if(USER::access('page') < 2) {
      $this->messageError = 'Недостаточно прав для удаления страницы!';
      return false;
    }
  ...
  public function deleteUser() {
    if(USER::access('user') < 2) {
      $this->messageError = 'Недостаточно прав для удаления пользователя!';
      return false;
    }
  ...
  public function deleteProduct() {
    if(USER::access('product') < 2) {
      $this->messageError = 'Недостаточно прав для удаления товара!';
      return false;
    }
  ...
  public function deleteOrder() {
    if(USER::access('order') < 2) {
      $this->messageError = 'Недостаточно прав для удаления заказа!';
      return false;
    }
  ...
  public function visibleProduct() {
    if(USER::access('page') < 2) {
      $this->messageError = 'Недостаточно прав для редактирования товара!';
      return false;
    }
  ...
  public function printOrder() {
    if(USER::access('order') == 0) {
      $this->messageError = 'Недостаточно прав для просмотра!';
      return false;
    }
  ...
  public function saveOrder() {
    ...
    foreach ($customFields as $key => $value) {
      ...
      if($row = DB::fetchAssoc($res)) {
        DB::query('UPDATE '.PREFIX.'custom_order_fields SET value = '.DB::quote($value).'
        ...
        DB::query('INSERT INTO '.PREFIX.'custom_order_fields (field, id_order, value) VALUES 
          ('.DB::quote($key).', '.DB::quoteInt($id).', '.DB::quote($value).')');
      }
    }
  ...
  public function saveUserProperty() {
    ...
    if (!empty($id)) {
      ...
      while($row = DB::fetchAssoc($res)) {
        if($row['type'] != 'none') {
          $array['type'] = $row['type'];
          $this->messageSucces = 'Сохранено! Тип не изменен!';
        }
      } 
  ...
  public function preDownload() {
    if(USER::access('setting') < 2) {
      $this->messageError = 'Недостаточно прав для обновления системы!';
      return false;
    }
    ...
    if(!in_array(PHP_MAJOR_VERSION.'.'.PHP_MINOR_VERSION, array('5.3', '5.4', '5.5', '5.6', '7.0', '7.1'))) {
      $this->messageError = 'Извините, Но ваша версия PHP не поддерживается';
    }
  ...
  public function postDownload() {
    if(USER::access('setting') < 2) {
      $this->messageError = 'Недостаточно прав для применения обновления!';
      return false;
    }
  ...
  public function saveDeliveryMethod() {
    ...
    switch ($status) {
      case 'createDelivery':
        $sql = "
          INSERT INTO `".PREFIX."delivery` (`name`,`cost`, `description`, `activity`,`free`, `date`, `ymarket`, `weight`)
          VALUES (
            ".DB::quote($deliveryName).", ".DB::quote($deliveryCost).", ".DB::quote($deliveryDescription).", ".DB::quote($deliveryActivity).", ".DB::quote($free).", ".DB::quote($deliveryDate).", ".DB::quote($deliveryYmarket).", ".DB::quote($weight)." 
          );";
 ...
 /**
  ...
  public function uploadCsvToImport() {
    ...
    if ($tempData['status'] == 'success') {
      $this->messageSucces = "Файл успешно загружен";
      return true;
    } else {
      $this->messageError = $tempData['msg'];
      return false;
  ...
  public function startImport() {
    if(USER::access('product') < 2) {
      $this->messageError = 'Недостаточно прав для импорта товаров!';
      return false;
    }
    $this->messageSucces = "Процесс запущен";
    $this->messageError = "Неудалось начать импорт";
  ...
  public function testMemcacheConection() {
    if (class_exists('Memcache')) {
      ...
      if (!empty($ver)) {
        $this->messageSucces = "Настройки корректны, соединение с Memcache установлено успешно. Версия: ".$ver;
        return true;
      }
  ...
  public function saveApi() {
    ...
    $this->messageSucces = 'Настройки API сохранены';
  ...
  public function saveStorage() {
    ...
    $this->messageSucces = 'Склады сохранены';
    $this->messageError = 'Произошла ошибка!'; 
  ...
  public function onOffStorage() {
    ...
    if($_POST['data'] == 'true') {
      ...
      $this->messageSucces = 'Склады включены';
    } else {
      MG::setOption('onOffStorage', 'OFF');
      $this->messageSucces = 'Склады выключены';
    }
    return true;
  }
  ...
  public function onOffCurrency() {
    ...
    if($_POST['data'] == 'true') {
      $this->messageSucces = 'Вывод валют включен';
    } else {  
      $this->messageSucces = 'Вывод валют выключен';
    }
  ...
  public function addImageToProp() {
    if(USER::access('setting') < 2) {
      $this->messageError = 'Недостаточно прав для загрузки изображения!';
      return false;
    }

    if($_FILES['propImg']['size'] > 1024 * 512) {
      $this->messageError = 'Загружать можно только изображения весом меньше 512Кб!';
      return false;
    }
    ...
    if(substr_count($_FILES['propImg']['type'], 'image') == '1') {
      ...
      $this->messageError = 'Загрузить можно только изображение!';
      return false;
    }
  ...
  public function getNumVKUpload() {
    $this->data = VKUpload::getNum($_POST['shopCats'], $_POST['inactiveToo']);
  ...
  public function uploadVKUpload() {
    $this->data = VKUpload::upload($_POST['access_token'], $_POST['vkCat'], $_POST['vkAlbum'], $_POST['productIDs'], $_POST['useNull']);
  ...
  public function getNumVKUploadDelete() {
    $this->data = VKUpload::getNumDelete($_POST['shopCats']);
  ...
  public function deleteVKUpload() {
    $this->data = VKUpload::delete($_POST['access_token'], $_POST['productIDs']);
  ...
  public function uploadAllMailChimp() {
    ...
    $this->messageSucces = 'Выгрузка началась';
    $this->messageError = 'Произошла ошибка (проверьте правильность настроек)';
  ...
  public function saveRetailCRM() {
    ...
    return RetailCRM::saveOptions($_POST['url'], $_POST['API'], $_POST['site'], $_POST['warehouseCode'], $_POST['paid'], $_POST['notPaid'], $_POST['syncUsers'], $_POST['syncOrders'], $_POST['syncRemains'], $_POST['retailStorage'], $_POST['retailStatuses'], $_POST['retailDeliverys'], $_POST['retailPayments'], $_POST['retailIndividual'], $_POST['retailLegal'], $_POST['reportSync'], $_POST['useOrderNumber']);
  }
  /**
  ...
  public function loadFields() {
    $this->data = unserialize(stripcslashes(MG::getSetting('optionalFields')));
    return true;
  }
  ...
  public function saveOptionalFields() {
    ...
    $this->messageSucces = 'Дополнительные поля сохранены';
    $this->messageError = 'Произошла ошибка'; 
  ...
  public function loadWholesaleRule() {
    ...
    while ($row = DB::fetchAssoc($res)) {
      ...
      $html .= '<td class="text-right"><i class="fa fa-trash"></i></td>';
      $html .= '</tr>';
    }
    if(empty($html)) {
      $html = '<tr><td colspan=3 class="text-center toDel">Правила не найдены</td></tr>';
    }
    $this->data = $html;
    return true;
  }
  ...
  public function saveWholesaleRule() {
    ...
    $this->messageSucces = 'Цены сохранены';
    $this->messageError = 'Произошла ошибка'; 
    DB::query('DELETE FROM '.PREFIX.'wholesales_sys WHERE 
      product_id = '.DB::quoteInt($_POST['product']).' AND 
      variant_id = '.DB::quoteInt($_POST['variant'])); 
    foreach ($_POST['data'] as $item) {
      DB::query('INSERT INTO '.PREFIX.'wholesales_sys (product_id, variant_id, count, price) VALUES
  ...
  public function saveUserGroup() {
    ...
    $this->messageSucces = 'Группа сохранена';
  ...
  public function dropGroup() {
    ...
    $this->messageSucces = 'Группа удалена';
    $this->messageError = 'Нельзя удалить стандартную группу!'; 
