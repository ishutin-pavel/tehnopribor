            ...
            <div class="mg-compare-product">
              ...
              <div class="mg-compare-product-inner">
                ...
                <ul class="mg-compare-product-list product-status-list">
                  ...
                  <li><?php if ($item['count']=='много'||$item['count'] == '-1') : ?>
                      <span class="count"><span class="sign">&#10004;</span> Есть в наличии </span>
                      <?php else:?>
                      <span>   Остаток: <span class="label-black count"><?php echo $item['count'] ?></span> шт. </span>  
                      <?php endif;?><?php echo $item['remInfo'] ?>
                  </li>
