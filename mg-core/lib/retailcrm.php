...
// MG::loger($options);
	...
	* @return bool
	*/
	static function saveOptions($url, $api, $site, $warehouseCode, $paid, $notPaid, $syncUsers, $syncOrders, $syncRemains, $retailStorage, $retailStatuses, $retailDeliverys, $retailPayments, $retailIndividual, $retailLegal, $reportSync, $useOrderNumber){
