	...
	<form method="post" action="<?php echo SITE?>/cart">
		<table class="cart-table">
			...
			<tr>
				...
				<td class="price-cell">
					<?php echo priceFormat($product['price']) ?> <?php echo $data['currency']; ?>
				</td>
				<td class="price-cell">
                    <?php echo priceFormat($product['countInCart'] * $product['price']) ?>  <?php echo $data['currency']; ?>
				</td>
			</tr>
			<?php endforeach;?>
			<tr>
				<td colspan="6" class="total-text">Стоимость всех товаров:</td>
