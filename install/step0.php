...
<div class="install-body">
    ...
    <div class="center-wrapper step1">
        ...
        <div class="install-text">
            ...
            <p>Перед началом установки необходимо ознакомиться с <a href="http://moguta.ru/license" target="_blank">"Лицензионным
        ...
        <div class="install-footer">
            <form action="" method="post">
                <div class="agree-blok">
                    <label>Я прочитал <a href="http://moguta.ru/license" target="_blank">"Условия использования"</a> и
