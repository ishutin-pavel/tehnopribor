...
[brcr]
    ...
    <div class="mg-product-slides-wrapper">
        <div class="info-line clearfix">
            <div class="code">
                Артикул: <span class="label-article code"><?php echo $data['code'] ?></span>
            </div>
            <div class="stock">
                ...
                <?php else:?>
                    Остаток: <span class="label-black count"><?php echo $data['count'] ?></span> шт. <?php echo $data['remInfo'] ?>
                <?php endif;?>
            </div>
        </div>
    ...
    <div class="product-status">
        <div class="buy-block">
            ...
            <div class="product-prices clearfix">
                ...
                <div class="price">
                    <?php echo $data['price'] ?> <?php echo $data['currency']; ?>
                </div>
            </div>
            <ul class="product-status-list">
                <li <?php echo (!$data['weight'])?'style="display:none"':'style="display:block"' ?>>
                    Вес: <span class="label-black weight"><?php echo $data['weight'] ?></span> кг.
                </li>
            </ul>
        ...
        <div class="buy-block-right">
            <!-- вывод плагина "триггер гаранитий" -->
            <!-- для вывода в этом месте настройки плагина для позиционирования из админки НЕ работают -->
            <!-- все позиционирование прописано в файле стилей style.css в папке шаблона -->
            <?php if (class_exists('trigger')): ?>
                <div class="mg-triggers">
    ...
    <div class="product-details-wrapper">
        <ul class="product-tabs clearfix">
            ...
            <?php if (class_exists('mgTreelikeComments')): ?>
                <li><a href="#tree-comments">Комментарии</a></li>
            <?php endif; ?>
