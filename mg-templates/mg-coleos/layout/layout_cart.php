                    ...
                    <tr>
                        <td class="small-cart-img">
                            <a href="<?php echo SITE . "/" . ($item['category_url'] ? $item['category_url'] : 'catalog') . "/" . $item['product_url'] ?>">
                                <img
                                    src="<?php echo SITE . "/uploads/thumbs/30_" . ($item['image_url'] ? $item['image_url'] : 'no-img.jpg') ?>"
...
<div class="mg-desktop-cart">
    <div class="cart">
        <div class="cart-inner">
            <ul class="cart-list">
                <li class="cart-qty">
                    Товаров <span class="countsht"><?php echo $data['cartCount']?$data['cartCount']:0 ?></span> шт.
