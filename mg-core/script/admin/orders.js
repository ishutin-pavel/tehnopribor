...
var order = (function () {
  return {
    ...
    init: function () {
      ...
      $('.admin-center').on('click', '.section-order .optional-fields-settings', function () {
        order.loadFields();
    ...
    getOrderContent: function () {
      ...
      $('#order-data .order-history tbody#orderContent tr').each(function () {
        if ($(this).data('id')) {
          ...
          obj += '"currency_iso":"' + encodeURIComponent($('#add-order-wrapper .currSpan [name=userCurrency]').val()) + '",';
                     ...
                     <div style="border-top:1px solid #eee;"></div>\
                      <div class="row"><div class="small-12 large-12 columns">\
                       <div class="order-payment-sum" style="margin:10px 20px;">\
                          ...
                          '<div class="row" '+($('#enabledStorage').text()==1?'':'style="display:none;"')+'>\
                              <div class="small-6 large-10 columns text-right"><span>'+lang.STORAGE+':</span></div>\
                              <div class="small-6 large-2 columns"><span class=""><strong>' + data.storage + '</strong></span></div>\
                          </div>' + 
                          '<div class="row">\
      ...
      var row = '\
       ...
       <li class="order-to-pdf has-menu">\
        ...
        <ul class="pdf-docs-list sub-list">\
          <li><a href="javascript:void(0);" data-id="' + element.id + '" data-template="qittance"><'+lang.TICKET+'/a></li>\
          <li><a href="javascript:void(0);" data-id="' + element.id + '" data-template="order">'+lang.BILL+'</a></li>\
          <li><a href="javascript:void(0);" data-id="' + element.id + '" data-template="sales_receipt">'+lang.PROD_TICKET+'</a></li>\
          <li><a href="javascript:void(0);" data-id="' + element.id + '" data-template="order_act">'+lang.ACCOUNT_ACT+'</a></li>\
        </ul>\
       </li>\
       <li class="order-to-print has-menu">\
        ...
        <ul class="print-docs-list sub-list">\
          ...
          <li><a href="javascript:void(0);" data-id="' + element.id + '" data-template="order">'+lang.BILL+'</a></li>\
          <li><a href="javascript:void(0);" data-id="' + element.id + '" data-template="sales_receipt">'+lang.PROD_TICKET+'</a></li>\
          <li><a href="javascript:void(0);" data-id="' + element.id + '" data-template="packing-list">'+lang.TORG-12+'</a></li>\
          <li><a href="javascript:void(0);" data-id="' + element.id + '" data-template="invoice">'+lang.INVOICE+'</a></li>\
          <li><a href="javascript:void(0);" data-id="' + element.id + '" data-template="order_act">'+lang.ACCOUNT_ACT+'</a></li>\
        </ul>\
       </li>\
    ...
    viewProduct: function (elementIndex) {
      ...
      html += '<div class="desc-sp">\
              <ul class="template-tabs-menu inline-list" style="margin-top:0">\
                ...
                '<li class="template-tabs button primary" part="props">\
                  <a href="javascript:void(0);"><span>'+lang.CHARACTERISTICS+'</span></a>\
                </li>'+
