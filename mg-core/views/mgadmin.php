    ...
    <div class="wrapper no-print">
        ...
        <?php 
          ...
          if (is_file(URL::getDocumentRoot().'uploads'.DIRECTORY_SEPARATOR.'customAdmin'.DIRECTORY_SEPARATOR.$adminLogo)) {
            ...
            $adminLogo = SITE.'/mg-admin/design/images/logo-normal.png';
          }
        ?>
          ...
          <div class="header-top info-panel">
            <div class="row">
              <div class="large-12 columns">
                <div class="header-left fl-left clearfix"><a class="logo" target="_blank" href="<?php echo SITE?>/mg-admin/"><img src="<?php echo $adminLogo; ?>"><span class="success badge"><?php echo VER ?></span></a>
